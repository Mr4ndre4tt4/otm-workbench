...
SCENARIOS = [
    ...
    RateScenario(
        code="LTL_TL_RATE_STACK",
        name="LTL/TL rate stack",
        description="Synthetic LTL/TL-style stack with offering, unit breaks, lane, geo, accessorial joins, stops, and cost hierarchy.",
        catalog_macro_object_code=RATE_RECORD_MACRO_OBJECT_CODE,
        tables=RATES_LOAD_SEQUENCE,
        required_tables=[
            "RATE_OFFERING",
