...
class Module(Base, TimestampMixin):
    ...
    group_key: Mapped[str] = mapped_column(String, default="build")
    group_label: Mapped[str] = mapped_column(String, default="Build")
    icon_key: Mapped[str] = mapped_column(String, default="box")
    sort_order: Mapped[int] = mapped_column(Integer, default=500)
    surface_type: Mapped[str] = mapped_column(String, default="module")
