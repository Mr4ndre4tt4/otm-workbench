...
- The Rules stage now includes schema node search and deterministic first-pass
  ...
  backend-owned `transform_type` facet, and local selection into a review set
  that displays source, target, transform, confidence, and reason.
