...
it applies the backend-owned Location operational and Item Packaging scenario
packs, verifies each scenario story and hidden manual controls,
creates/validates/publishes each scenario draft, resets authoring state, then
