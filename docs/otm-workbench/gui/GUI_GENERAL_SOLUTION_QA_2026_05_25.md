...
3. Continue Integration Mapping accelerator hardening: suggestion scoring with Catalog/Data Dictionary semantics, schema path facets, and complex expression usability.
