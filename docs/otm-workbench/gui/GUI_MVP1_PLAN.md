...
- Workbench shell pattern contract
  documented in GUI_WORKBENCH_SHELL_PATTERN_CONTRACT.md
...
- Operational list pattern contract
  documented in GUI_OPERATIONAL_LIST_PATTERN_CONTRACT.md
...
- GUI synthetic fixtures contract
  documented in GUI_SYNTHETIC_FIXTURES_CONTRACT.md
- GUI decisions log
