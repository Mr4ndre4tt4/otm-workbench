...
| Master Data / Data Factory | `GUI_MASTER_DATA_DATA_FACTORY_REDESIGN_SPEC.md` | `GUI_MASTER_DATA_VIEW.md`, `GUI_MASTER_DATA_COMPLETION_REVIEW_OTM115.md`, `GUI_MASTER_DATA_MVP_WORKFLOW_REVIEW_OTM119.md`, `output/gui-qa/master-data/` | Full click-by-click redesign spec exists; Slice 1 hub and route-family separation is delivered with React and browser QA evidence. | Continue Slice 2: operational template list/detail routes with Back actions and no heavy selected-object side panel. |
